					...
					<main role="main" className="col-lg-12 text-center">
						...
						<div className="row content">
							<div className="col user-controls">
								...
								<button onClick={this.rebalanceHandler}>更新</button>
								<br />
								<button onClick={this.withdrawHandler}>提现</button>

							</div>
							<div className="col user-stats">
								<p>账户余额（DAI）: {this.state.walletBalance}</p>
								<p>池子中 (DAI): {this.state.aggregatorBalance}</p>
								<p>目前的协议: {this.state.activeProtocol}</p>
							</div>
						</div>
					</main>
