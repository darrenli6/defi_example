...
const init = async () => {
    ...
    .on('data',async block=>{
        console.log(`new block recived. Block # ${block.number} ` );
        ...
        const uniswapResults  = await Promise.all([
            daiWeth.getOutputAmount(new TokenAmount(dai,AMOUNT_DAI_WEI)),  //get eth
            daiWeth.getOutputAmount(new TokenAmount(weth,AMOUNT_ETH_WEI)),  //get  dai 
        ]);
